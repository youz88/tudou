...
public class RSAUtil {
    ...
    public static boolean checkSign(String content, String sign, String publicKey) {
        try {
            ...
            if (LogUtil.ROOT_LOG.isErrorEnabled())
                LogUtil.ROOT_LOG.error("rsa check sign exception", e);
        }
        return false;
    }
     ...
     * 从文件中加载私钥
     */
    public static String loadPrivateKey(InputStream in) {
        ...
        try {
            ...
            U.assertException(true,"私钥数据读取错误");
        } catch (NullPointerException e) {
            U.assertException(true,"私钥输入流为空");
        }finally {
            if(U.isNotBlank(br)){
                try {
                    br.close();
                } catch (IOException e) {
                    U.assertException(true,"关闭读取私钥数据IO错误");
                }
            }
            if(U.isNotBlank(is)){
                try {
