...
public class TaskConfig implements AsyncConfigurer {
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setCorePoolSize(U.PROCESSORS << 1);     // 线程池核心数: cpu 核心数 * 2
        executor.setMaxPoolSize(U.PROCESSORS << 2);      // 线程池最大数: cpu 核心数 * 4
        executor.setQueueCapacity(U.PROCESSORS << 4);    // 队列总数:    cpu 核心数 * 16
